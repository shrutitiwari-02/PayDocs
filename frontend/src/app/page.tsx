...
const DOC_UTILITIES: ToolItem[] = [
  { 
    name: "Merge PDF", 
    desc: "Combine multiple PDF documents into a single cohesive file", 
    icon: Layers, 
  ...
  { 
    name: "Split PDF", 
    desc: "Extract specific pages or separate documents effortlessly", 
    icon: Scissors, 
  ...
  { 
    name: "Compress PDF", 
    desc: "Optimize file size while maintaining pristine visual clarity", 
    icon: Minimize2, 
  ...
  { 
    name: "Image to PDF", 
    desc: "Convert PNG, JPG, and web images directly into PDF documents", 
    icon: FileImage, 
  ...
  { 
    name: "PDF to Image", 
    desc: "Extract high-resolution image pages from PDF documents", 
    icon: FileImage, 
  ...
  { 
    name: "Add Watermark", 
    desc: "Stamp custom text or confidential security markings across all pages", 
    icon: Droplet, 
  ...
  { 
    name: "Page Numbers", 
    desc: "Automatically number and index multi-page PDF files", 
    icon: ListOrdered, 
  ...
  { 
    name: "Rotate PDF", 
    desc: "Adjust page orientation by 90°, 180°, or 270° degrees", 
    icon: RotateCw, 
  ...
  { 
    name: "Sign PDF", 
    desc: "Draw, upload, and embed signatures securely onto documents", 
    icon: PenTool, 
    href: "/tools/pdf-sign", 
  ...
  { 
    name: "Word to PDF", 
    desc: "Convert Microsoft Word .docx documents to formatted PDFs", 
    icon: FileType2, 
  ...
  { 
    name: "PDF to Word", 
    desc: "Transform PDFs back into editable Word document files", 
    icon: FileType2, 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
            {DOC_UTILITIES.map((tool) => (
              <Link
                key={tool.name}
                href={tool.href}
                className="group relative flex flex-col justify-between p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-xs hover:shadow-2xl hover:border-blue-500/40 transition-all duration-300 hover:-translate-y-1 overflow-hidden"
              >
                {/* Glowing Top Line Accent */}
                <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${tool.gradient} opacity-80 group-hover:opacity-100 group-hover:h-1.5 transition-all`} />

                <div>
                  <div className={`w-11 h-11 rounded-xl bg-gradient-to-br ${tool.gradient} text-white flex items-center justify-center mb-4 shadow-md ${tool.glow || ''} group-hover:scale-110 transition-transform duration-300`}>
                ...
                <div className="mt-5 pt-3 border-t border-slate-100 dark:border-slate-800/60 flex items-center justify-between text-xs font-bold text-slate-500 dark:text-slate-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
